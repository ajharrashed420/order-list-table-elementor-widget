	...
	protected function register_controls()
	{
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .oltew-order-list-table table th .order_list_icon, {{WRAPPER}} .oltew-order-list-table table th .
					order_list_icon svg' => 'width: {{SIZE}}{{UNIT}};',
							...
							?>
								<tr style="text-align:<?php echo esc_html($oltew_table_td_alignment); ?>;">
									...
									<?php if ($hide_order_sl !== 'yes') { ?>
										<td class="order_sl"><?php echo esc_html($sl++); ?></td>
									<?php }; ?>
